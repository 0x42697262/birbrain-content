...
Frida is a dynamic instrumentation toolkit that injects scripts into running
processes to hook and manipulate function calls at runtime.

Notes gathered on using Frida to hook Unity/Android games:
