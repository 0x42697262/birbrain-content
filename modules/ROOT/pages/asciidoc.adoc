...
....
xref:writeups:random:attachment$cmsc134-machine-problem-1/vuln.c[vuln.c]
....
...
[,c]
----
\include::writeups:random:attachment$cmsc134-machine-problem-1/vuln.c[]
----
....
...
Visit xref:writeups:random:cmsc134-machine-problem-1-sources.adoc[this] working reference.
