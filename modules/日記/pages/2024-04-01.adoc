...
Someone (I forgot where I got it actually) mentioned that I should run xref:ROOT:virt-manager.adoc[Virtual Manager] with xref:ROOT:xwayland.adoc[XWayland] backend.
